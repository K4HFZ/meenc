...
const starts = async (dha = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('BAPAK KOK DITANAH JADI SINGKONG YAA AWOWKWK', {
		font: 'Standard',
	...
	console.log(color('[ITU BAPAP APA TANAH?\n\n', 'orange'), color('\n======WOI ANAK YATIM======\n•AWOWKWKW YATIM PIATU', 'yellow'))
	console.log(color('\n\nJANGAN DI JUAL ULANG BRO😑\nKALAU ADA YG MINTA SURUH CHAT ©AING😅\nWA KAHFZ 62813658142009😗', 'pink'))
	...
	dha.on('connecting', () => {
		console.log(color('[ KAHFZ GANTENG AJG ]', 'purple'), color('PROSES PENYAMBUNGAN'));
	})
const spinner = { 
  "interval": 120,
  "frames": [
	...
	//connect
	dha.on('open', () => {
		console.log(color('[ KAHFZ GANTENG SUMPAH ]', 'purple'), color('BOT SUDAH AKTIF SELAMAT MENGGUNAKAN'));
	})
