//Sama Vina ubah² ya:)
//soalnya saya gak keburu ubah² hehe
//jangan lupa shalat
//yg udh ku ubah yg di bagian List menu😁
//JANGAN JUAL SC INI YA:)
//KALO ADA YG MINTA/MAKSA BILANG KE SAYA BIAR SAYA SPAM VIRTEX🤣
...
dha.sendMessage(id, buttonMessages, MessageType.buttonsMessage, options)
        ...
        case 'menu':
        case 'help':
        menu =`Hai Kak.....\n*${pushname}*\n\`\`\`Saya Vina-Botz,SENANG BISA BERTEMU DENGANMU HARI INI\`\`\`
...
©𝑪𝒓𝒆𝒂𝒕𝒐𝒓 ©kurrtod`
               ...
               buttonsMessage = {
               contentText: `${menu}`,
               footerText: '\`\`\`MAU BELI SC INI HUBUNGIN VINA YA WA wa.me/6285239345095\`\`\`', imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
